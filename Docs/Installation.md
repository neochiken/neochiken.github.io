...
Once you have everything set in Wabbajack, hit **GO** and let it do its thing. Nexus mods will download automatically if you have premium. Loverslab requires manual downloads, you can either follow the instructions at the top of each popup window for what mod to download or download them ahead of time from the commonly failing downloads link in the next section. It might take a while as there is a fair bit to download and the speed of this will depend on your internet performance as well as your CPU in the later stages for hashing and unpacking the downloads.
